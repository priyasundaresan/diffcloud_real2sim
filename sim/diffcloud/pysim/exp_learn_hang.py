...
with open('conf/rigidcloth/cloth_hang/demo2.json','r') as f:
	config = json.load(f)
...
def get_loss_per_iter(sim, epoch, sim_step, demo_dir, save, initial_states=None):
    ...
    if (save):
        ...
        plot_pointclouds([curr_pcl, ref_pcl, initial_pcl], title='%s/fixed_epoch%02d-%03d'%(out_path,epoch,sim_step), angle=0)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d', '--demo_dir', type=str, default=os.path.join('hang_sim_pcls/4'))
